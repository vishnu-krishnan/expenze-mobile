...
class _MonthPlanScreenState extends State<MonthPlanScreen> {
                  ...
                  if (expenseProvider.isLoading &&
                    ...
                    SliverToBoxAdapter(
                      child: _buildMonthNavigator(
                        expenseProvider.currentMonthKey,
                      ),
                    ),
  ...
  Widget _buildPremiumSummary(ExpenseProvider provider) {
    ...
    final limit = (summary['limit'] ?? 0.0).toDouble();

    final target = limit > 0 ? limit : (planned > 0 ? planned : 0.0);
    final pctUsed = target > 0 ? (actual / target) : (actual > 0 ? 1.01 : 0.0);
              ...
              children: [
                ...
                Builder(
                  builder: (context) {
                    ...
                    final pConf = (confirmedPlanned / base * 100).toInt();
                    final pPend = (pendingPlanned / base * 100).toInt();
                    final pUnpl = (unplanned / base * 100).toInt();
  ...
  Widget _buildEmptyState() {
    final secondaryTextColor = AppTheme.getTextColor(
      context,
      isSecondary: true,
    );
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Rent? Coffee? That subscription you forgot? Add them here.',
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDetailRow(
              ...
              valueColor: expense.isPaid ? AppTheme.success : AppTheme.warning,
            ),
  ...
  void _showPaidDialog(Expense expense, ExpenseProvider provider) {
    ...
    final controller = TextEditingController(
      text: expense.plannedAmount.toStringAsFixed(0),
    );
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  dropdownColor: modalBgColor,
                  items:
                      ['Other', 'Cash', 'Card', 'UPI', 'Net Banking', 'Wallet']
                          .map(
